...
func doExample(request *http.Request) *http.Request {
	request.Header.Add("Example-Header", "1")
...
func testExample() {
	// Given
	requestURL := fmt.Sprintf("http://localhost:%d/api/example?foo=1&bar=2&baz=3", ServerPort)
